...
RSpec.describe RoadTripFacade do
  it 'build_facade' do
    VCR.use_cassette 'road trip facade class method' do
  ...
  it 'instance methods' do
    VCR.use_cassette 'road trip facade instance methods' do
